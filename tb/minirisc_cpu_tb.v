module minirisc_cpu #(
    ...
    register_file u_regfile (
        ...
        // Selected writeback value
        .write_data(writeback_data),

        // Actual write only occurs during WRITEBACK
    ...
    // The Control Unit says whether the instruction
    // requires a register write.
    //
    // The FSM says WHEN that write is allowed.
    ...
    // Flags are captured during EXECUTE.
    ...
    // STORE writes memory during EXECUTE.
    ...
    // PC only changes once per completed instruction.
